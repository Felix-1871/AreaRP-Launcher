    ...
    async getCrack() {
        ...
        connectOffline.addEventListener('click', async () => {
            if (emailOffline.value.length < 3) {
                popupLogin.openPopup({
                    title: 'Błąd',
                    content: 'Twój nick musi mieć co najmniej 3 znaki.',
                    options: true
                });
                return;
            }
            ...
            if (emailOffline.value.match(/ /g)) {
                popupLogin.openPopup({
                    title: 'Błąd',
                    content: 'Twój nick nie może zawierać spacji.',
                    options: true
                });
                return;
            }
    ...
    async getAZauth() {
        ...
        AZauthConnectBTN.addEventListener('click', async () => {
            ...
            if (AZauthEmail.value == '' || AZauthPassword.value == '') {
                PopupLogin.openPopup({
                    title: 'Błąd',
                    content: 'Wprowadź adres e-mail i hasło.',
                    options: true
                });
                return;
            }
