...
class Login {
    ...
    async loginMojang() {
        ...
        loginBtn.addEventListener("click", async () => {
            ...
            infoLogin.innerHTML = "Połączenie w toku...";


            if (mailInput.value == "") {
                infoLogin.innerHTML = "Wprowadź swój adres e-mail / nazwę użytkownika"
            ...
            if (passwordInput.value == "") {
                infoLogin.innerHTML = "Wprowadź swoje hasło"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
    ...
    async loginOffline() {
        ...
        loginBtn.addEventListener("click", async () => {
            ...
            if (mailInput.value.length < 3) {
                infoLogin.innerHTML = "Nazwa użytkownika musi mieć co najmniej 3 znaki"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            if (account_connect == null || account_connect.error) {
                console.log(account_connect.error)
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
